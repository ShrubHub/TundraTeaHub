...
(
  air <- ggplot() +
    ...
    scale_colour_manual(values = c("#00b100", "#8B2323"), name = "Tea Type") +
    scale_fill_manual(values = c("#00b100", "#8B2323"), name = "Tea Type") +
...
season_narm_r$envlevel <-
  apply(season_narm_r[, 63:64], 1, max)# Add categories
